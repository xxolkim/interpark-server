// const express = require("express") ; 예전 commonjs 방식
...
const app = express();
const port = 4000; // 서버 접속시 포트 번호

// cors 처리(웹 브라우저로 접속시 보안관련 처리)
app.use(
  cors({
    origin: "*",
  })
...
// 게시판 API (백엔드 호출 함수)
// get 은 프론트에서 자료 요청
// localhost:4000/board : 게시판 자료 요청
app.get("/board", (req, res) => {
  console.log("GET", req);
  // DB 에서 조건을 보고 결과를 {} 만들어서 [] 담아서 줌
...
// localhost:4000/board : 게시판 자료를 추가
// axios.post("/board", {자료})
